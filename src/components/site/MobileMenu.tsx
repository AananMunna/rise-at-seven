...
const sections = [
  ...
  {
    label: "Industries",
    items: ["B2B Marketing", "Retail", "Finance", "Tech", "Travel"],
  },
          ...
          <nav className="mt-6">
                    ...
                    <div className="overflow-hidden">
                      <ul className="space-y-3 pt-1 text-[18px] font-medium text-white/80">
                        {s.items.map((item) => (
                          <li
                            key={item}
                            className="hover:text-white cursor-pointer transition-colors px-1"
                          >
                            {item}
                          </li>
                        ))}
            ...
            <ul className="mt-2">
              {links.map((l) => (
                <li
                  key={l}
                  className="border-b border-white/10 py-4 font-display text-[28px] font-bold tracking-tight leading-none"
                >
                  {l}
                </li>
              ))}
              {resourceLinks.map((l) => (
                <li
                  key={l}
                  className="border-b border-white/10 py-4 flex items-center justify-between font-display text-[28px] font-bold tracking-tight leading-none"
                >
                  {l}
                  <div className="grid h-6 w-6 place-items-center rounded-full bg-white/10">
                    <ChevronDown className="h-3.5 w-3.5 text-white/70" />
